...
class UFCStatsScraper:
    ...
    def parse_fighter_details(self, fighter_url, old_data=None):
        ...
        try:
            ...
            # Sadece UFC maçlarını sayıyoruz
            ufc_fights = [row for row in soup.find_all('tr', class_='b-fight-details__table-row')[1:]
...
if __name__ == "__main__":
    ...
    # test_url = "http://ufcstats.com/fighter-details/35673bf5204524ee"
