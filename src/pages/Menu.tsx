          ...
          >
            <defs>
              ...
              >
                <stop
                  offset="0%"
                  stopColor={theme === "dark" ? "#374151" : "#494949"}
                />
                <stop
                  offset="100%"
                  stopColor={theme === "dark" ? "#1f2937" : "#8b8b8b"}
                />
              </linearGradient>
            </defs>
            <path
          ...
          >
            <defs>
              ...
              >
                <stop
                  offset="0%"
                  stopColor={theme === "dark" ? "#475569" : "#a8a8a8"}
                />
                <stop
                  offset="50%"
                  stopColor={theme === "dark" ? "#334155" : "#5c5c5c"}
                />
                <stop
                  offset="100%"
                  stopColor={theme === "dark" ? "#1e293b" : "#8a8a8a"}
                />
              </linearGradient>
              {/* Snow caps gradient */}
              <linearGradient
          ...
          >
            <defs>
              ...
              >
                <stop
                  offset="0%"
                  stopColor={theme === "dark" ? "#4b5563" : "#dbdbdb"}
                />
                <stop
                  offset="40%"
                  stopColor={theme === "dark" ? "#374151" : "#aaaaaa"}
                />
                <stop
                  offset="100%"
                  stopColor={theme === "dark" ? "#1f2937" : "#9b9b9b"}
                />
              </linearGradient>
              <linearGradient
                id="mountainShadow"
              ...
              >
                <stop
                  offset="0%"
                  stopColor={theme === "dark" ? "#1f2937" : "#bdbdbd"}
                />
                <stop
                  offset="50%"
                  stopColor={theme === "dark" ? "#374151" : "#a7a7a7"}
                />
                <stop
                  offset="100%"
                  stopColor={theme === "dark" ? "#1f2937" : "#d8d8d8"}
                />
              </linearGradient>
            </defs>
           ...
           L1440,80 L1440,300 Z"
            ...
            <path
              ...
              stroke={theme === "dark" ? "#6b7280" : "#e0e0e0"}
              strokeWidth="1"
              fill="none"
              opacity="0.5"
            />
            <path
              ...
              stroke={theme === "dark" ? "#6b7280" : "#dadada"}
              strokeWidth="1"
              fill="none"
              opacity="0.5"
            />
