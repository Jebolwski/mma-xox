  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center p-6">
        <div
          className={`mt-16 p-8 rounded-2xl shadow-2xl border backdrop-blur-sm w-full max-w-md transition-all duration-300 ${
            theme === "dark"
              ? "bg-slate-800/60 border-slate-600/50 text-slate-100"
              : "bg-white/60 border-slate-200/50 text-slate-800"
          }`}
        >
